...
public class ImportWorldInventory extends BaseInventory{
    ...
    public Inventory getInventory(Player player, Object... options){
        ...
        setItem(inv, itemStackUtils.getItemStack(GUIItem.IMPORT_TYPE_NORMAL, getMessage(Message.NEW_WORLD_NORMAL), lore), 2, 2);
        setItem(inv, itemStackUtils.getItemStack(GUIItem.IMPORT_TYPE_VOID, getMessage(Message.NEW_WORLD_VOID), lore), 2, 3);
